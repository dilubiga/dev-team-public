...
description: Grooms raw tasks into agent-ready specs (Job 1) AND performs final user-perspective acceptance review before any code is committed (Job 2). The PM is the first and last gate in the pipeline.
